 ...
 *
 * BESKRIVNING 
 * Ett testprogram där användaren kan skapa moneyobjekt.
 * Användaren kan även testa ett antal operationer och
 * tilldelningsmetoder med hjälp av de skapade moneyobjekten.
 * 
 */
#include <iostream>
#include <string>
 ...
 *
 * Räknar upp moneyobjektet prefixt.
 */
 ...
 *
 * Räknar upp moneyobjektet postfixt.
 */
 ...
 *
 * Räknar ner moneyobjektet prefixt.
 */
 ...
 *
 * Räknar ner moneyobjektet postfixt.
 */
 ...
 * FUNKTION down_postfix(vector<Money>& list)
 *
 * Jämför två moneyobjekt med ett antal opperatorer.
 */
